...
// funzione che crea un array con tutti i generi dei film presenti nell'array movies
function genreArrayFunction(movies) {
    // array vuoto dove andranno i generi
    const genreArray = [];
    // cicliamo sull'array dei film e otteniamo gli elementi singoli
    movies.forEach(movie => {
        // verifichiamo che quei elementi, in particolare il genere, non sia presente nell'array creato in precedenza
        if (!genreArray.includes(movie.genre)) {
            // se non è presente, pushare
